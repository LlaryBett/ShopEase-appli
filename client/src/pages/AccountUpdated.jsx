...
const Account = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const url = isSignUp ? "/users/register" : "/users/login"; // Adjust the URL based on the action
    const body = isSignUp
      ? { username, password, confirmPassword, role: "customer" } // Assuming role is customer for signup
      : { username, password };
