...
const RefreshYourDay = ({ isAuthenticated }) => {
  ...
  // Fetch products from the "Refresh Your Day" section from the backend
  useEffect(() => {
    const fetchRefreshYourDayProducts = async () => {
      try {
        const response = await fetch(
          "https://shopease-appli.onrender.com/api/products/section/Refresh%20Your%20Day"
        );
  ...
  return (
    <div className="pt-12"> {/* Adjust padding-top based on header height */}
      <div className="flex justify-between items-center mb-2">
        <h2 className="text-2xl font-bold text-gray-800">Refresh Your Day</h2>
